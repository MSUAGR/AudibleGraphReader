...
def get_xdata(cropped_img, y_pixel_line, x_pixel_line, x_axis_exists, longest_yline_size, longest_xline_size):
    ...
    for i in range(len(x_axis_value_medians)):
        ...
        res, col = get_line_positions(cropped_img, x_axis_exists, y_pixel_line, longest_xline_size, x_axis_points)
    ...
    for i in range(len(new_datapoints)):
        for j in range(len(new_datapoints[i])):
            ...
            #d = cropped_img[new_datapoints[i][j][1], new_datapoints[i][j][0]]
...
def get_line_positions(cropped_img, x_axis_exists, y_pixel_line, longest_xline_size, x_axis_points):
    ...
    return new_datapoints, new_datapoints_colors
...
def main():
    ...
    x_axis_values = get_xdata(cropped_img, y_pixel_line, x_pixel_line, x_axis_exists, longest_yline_size, longest_xline_size)
main()